...
INSERT INTO city (`idcity`, `name`, `code`, `population`, `country_id`, `country_id2`) VALUES ('3', 'Madrid', 'M', '8', '3', 'compose_pk') ON DUPLICATE KEY UPDATE `idcity` = '3',`name` = 'Madrid',`code` = 'M',`population` = '8',`country_id` = '3',`country_id2` = 'compose_pk';
INSERT INTO car (`idcar`, `carcol`) VALUES ('5', 'Jaguar') ON DUPLICATE KEY UPDATE `idcar` = '5',`carcol` = 'Jaguar';
INSERT INTO persone_has_car (`persone_idpersone`, `car_idcar`) VALUES ('5', '5') ON DUPLICATE KEY UPDATE `persone_idpersone` = '5',`car_idcar` = '5';
INSERT INTO persone_has_car (`persone_idpersone`, `car_idcar`) VALUES ('4', '4') ON DUPLICATE KEY UPDATE `persone_idpersone` = '4',`car_idcar` = '4';
